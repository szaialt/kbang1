...
/////////////
    ...
    inline void setUnlimitedBangs(int unlimited)   {
        m_unlimitedBangs = unlimited;
    }
    
    inline  QList<PublicPlayerView*> adversaries()        const { return m_adversaries; }
     ...
     * @see void Player::onBangPlayed(bool b)
     */
