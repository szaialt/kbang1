...
CharacterWilliamLongley::CharacterWilliamLongley(QObject* parent):
        CharacterBase(parent, CHARACTER_WILLIAM_LONGLEY)
{

}

int CharacterWilliamLongley::maxLifePoints() const {
    return 3;
}

void CharacterWilliamLongley::respondCard(ReactionHandler* reactionHandler, PlayingCard* targetCard){
