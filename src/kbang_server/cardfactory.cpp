    ...
    void generateCards(Game* game, QMap<int, PlayingCard*>& res)
    {
      ...
      //////////
        ...
        if (game->gameInfo().teamFortressFlag()){
             ...
             //list.append(new CardMissed(game, id(), CardMissed::DeadRinger, SUIT_SPADES, 4)); cardTaker ciklusba esik: 7-8
        ...
        if (game->gameInfo().martinCityFlag()){
            ...
            list.append(new CardBang(game, id(), CardBang::Undefensable, SUIT_CLUBS, 14)); 
