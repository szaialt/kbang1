...
/**
     * Returns the last player that is before the currentPlayer
     * and is alive.
     */
    Player* previousPlayer(Player* currentPlayer);    
    ...
    PlayerReaper* getPlayerReaper(){return mp_playerReaper;}
...
///////////////
     ...
     */
    void startGame(Player* player, int n);
...
private:
    void checkStartable();
    void shufflePlayers();
    void setRolesAndCharacters(int n);
