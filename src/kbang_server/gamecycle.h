...
public:
    ...
    void playCard(Player* player, PlayingCard* card, PlayingCard* targetCard, Player* targetPlayer);
    void playCard(Player* player, PlayingCard* card, PlayingCard* targetCard);
    void playCard(Player* player, PlayingCard* card, QList<PlayingCard*> targetCards);
    void playCard(Player* player, PlayingCard* card, QList<PublicPlayerView*> targetPlayers);
