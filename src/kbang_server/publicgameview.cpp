...
//     res.description = description();
    ...
    res.lifePointsMaxFlag  = mp_game->gameInfo().lifePointsMaxFlag();
    res.ourFlag  = mp_game->gameInfo().ourFlag();
    res.dodgeCityFlag  = mp_game->gameInfo().dodgeCityFlag();
    res.teamFortressFlag  = mp_game->gameInfo().teamFortressFlag();
    res.stackingDynamiteFlag = mp_game->gameInfo().stackingDynamiteFlag();
    ...
    res.thirtythreeCharactersFlag  = mp_game->gameInfo().thirtythreeCharactersFlag();
