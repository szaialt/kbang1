...
enum PlayingCardType {
    ...
    CARD_CANNON,
    CARD_ARTILLERY,
    CARD_PURPLE_FUR_TRADE,
    CARD_PURPLE_WARPATH,
    CARD_PURPLE_LOAN,
    CARD_PURPLE_INVESTMENT,
    CARD_PURPLE_TOMAHAWK,
    CARD_PURPLE_MOLOTOV_COCKTAIL,
    CARD_PURPLE_SHOWTIME,
    CARD_Q_AND_A,
    CARD_DISARM,
    CARD_PAY_DAY,
    CARD_PURPLE_ON_THE_HOUSE,
    CARD_PURPLE_MOONSHINE,
    CARD_TAUNT,
    CARD_STAND_OFF,
    CARD_AMBUSH,
    CARD_BACK_UP,
