...
//             if (createGameData.lifePointsMaxFlag) std::cout << "GameInfo: lifePointsMaxFlag" << std::endl;
//             else std::cout << "GameInfo: !lifePointsMaxFlag" << std::endl;
//     
//             if (createGameData.ourFlag) std::cout << "GameInfo: ourFlag" << std::endl;
//             else std::cout << "GameInfo: !ourFlag" << std::endl;
//     
//             if (createGameData.dodgeCityFlag) std::cout << "GameInfo: dodgeCityFlag" << std::endl;
//             else std::cout << "GameInfo: !dodgeCityFlag" << std::endl;
//     
//            if (createGameData.stackingDynamiteFlag) std::cout << "GameInfo: stackingDynamiteFlag" << std::endl;
//            else std::cout << "GameInfo: !stackingDynamiteFlag" << std::endl;
//             
...
//         //This must be controlled - is there a bug?
//         if (action->name() == "character-choicing") {
//             PublicPlayerData data;
//             data.read(action);
//             return;
//         }
//         //This must be controlled - is there a bug? 
//         if (action->name() == "character-ordering") {
//             PublicPlayerData data;
//             data.read(action);
//             return;
//         }
...
//         if (event->name() == "character-choicing") {
//             PublicPlayerData data;
//             data.read(event);
//             emit sigEventChooseCharacter(data);
//             return;
//         }
//         if (event->name() == "character-ordering") {
//             PublicPlayerData data;
//             data.read(event);
//             emit sigEventOrderCharacters(data);
//             return;
//         }
...
// void Parser::eventChoicingCharacter(const PublicPlayerData& publicPlayerData){
//     ASSERT_SOCKET;
//     eventStart();
//     mp_streamWriter->writeStartElement("character-choicing");
//     publicPlayerData.write(mp_streamWriter);
//     mp_streamWriter->writeEndElement();
//     emit sigEventChooseCharacter(publicPlayerData);
//     eventEnd(); 
// 
// } 
// 
// void Parser::eventOrderingCharacter(const PublicPlayerData&  publicPlayerData){
//     ASSERT_SOCKET;
//     eventStart();
//     mp_streamWriter->writeStartElement("character-ordering");
//     publicPlayerData.write(mp_streamWriter);
//     mp_streamWriter->writeEndElement();
//     emit sigEventOrderCharacters(publicPlayerData);
//     eventEnd();
// 
// }
...
// void Parser::actionChoicingCharacter(PublicPlayerData& publicPlayerData){
//     ASSERT_SOCKET;
//     actionStart();
//     mp_streamWriter->writeStartElement("character-choicing");
//     publicPlayerData.write(mp_streamWriter);
//     mp_streamWriter->writeEndElement();
//     sigActionCharacterChoicing(publicPlayerData);
//     actionEnd();
// 
// }
// 
// void Parser::actionOrderingCharacter(PublicPlayerData& publicPlayerData){
//     ASSERT_SOCKET;
//     actionStart();
//     mp_streamWriter->writeStartElement("character-ordering");
//     publicPlayerData.write(mp_streamWriter);
//     mp_streamWriter->writeEndElement();
//     sigActionCharacterOrdering(publicPlayerData);
//     actionEnd();
// 
// }
