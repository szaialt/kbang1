...
//     void actionChoicingCharacter(PublicPlayerData& publicPlayerData);
//     void actionOrderingCharacter(PublicPlayerData& publicPlayerData);
...
//     void sigEventChooseCharacter(const PublicPlayerData&);
//     void sigEventOrderCharacters(const PublicPlayerData&);
    ...
    // SERVER //
    ////////////
    //Characters settings come from server
public:
    ...
    /*void eventChoicingCharacter(const PublicPlayerData& publicPlayerData);
    void eventOrderingCharacter(const PublicPlayerData&  publicPlayerData);*/ 
...
//     void sigActionCharacterChoicing(PublicPlayerData&);
//     void sigActionCharacterOrdering(PublicPlayerData&);
