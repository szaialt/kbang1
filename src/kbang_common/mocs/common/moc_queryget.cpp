...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QueryGet_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QueryGet_t qt_meta_stringdata_QueryGet = {
    {
QT_MOC_LITERAL(0, 0, 8), // "QueryGet"
QT_MOC_LITERAL(1, 9, 6), // "result"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 14), // "ServerInfoData"
QT_MOC_LITERAL(4, 32, 12), // "GameInfoData"
QT_MOC_LITERAL(5, 45, 16), // "GameInfoListData"
QT_MOC_LITERAL(6, 62, 4), // "pong"
QT_MOC_LITERAL(7, 67, 7) // "latency"
...
void QueryGet::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QueryGet::*)(const ServerInfoData & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QueryGet::result)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QueryGet::*)(const GameInfoData & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QueryGet::result)) {
                *result = 1;
                return;
            }
        ...
        {
            using _t = void (QueryGet::*)(const GameInfoListData & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QueryGet::result)) {
                *result = 2;
                return;
            }
        ...
        {
            using _t = void (QueryGet::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QueryGet::pong)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QueryGet::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QueryGet.data,
      qt_meta_data_QueryGet,  qt_static_metacall, nullptr, nullptr}
};
...
void *QueryGet::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QueryGet.stringdata0))
