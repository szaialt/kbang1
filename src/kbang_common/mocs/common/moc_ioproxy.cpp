...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_IOProxy_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_IOProxy_t qt_meta_stringdata_IOProxy = {
    {
QT_MOC_LITERAL(0, 0, 7), // "IOProxy"
QT_MOC_LITERAL(1, 8, 10), // "networkOut"
...
void IOProxy::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (IOProxy::*)(QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&IOProxy::networkOut)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject IOProxy::staticMetaObject = {
    { &QIODevice::staticMetaObject, qt_meta_stringdata_IOProxy.data,
      qt_meta_data_IOProxy,  qt_static_metacall, nullptr, nullptr}
};
...
void *IOProxy::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_IOProxy.stringdata0))
