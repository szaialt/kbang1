...
//With Dodge City we can have a sheriff with 10 HPP 
//int CardWidget::sm_lifeLevels[11] = {0, 19/2, 31/2, 44/2, 57/2, 68/2, 87/2, 99/2, 112/2, 136/2, 153/2};
...
{
//     sm_lifeLevels = {0, 19/2, 31/2, 44/2, 57/2, 68/2, 87/2, 99/2, 112/2, 136/2, 153/2};
    sm_lifeLevels[0] = 0;
    sm_lifeLevels[1] = 19/2;
    sm_lifeLevels[2] = 31/2;
    sm_lifeLevels[3] = 44/2;
    sm_lifeLevels[4] = 57/2;
    sm_lifeLevels[5] = 68/2;
    sm_lifeLevels[6] = 87/2;
    sm_lifeLevels[7] = 99/2;
    sm_lifeLevels[8] = 112/2;
    sm_lifeLevels[9] = 136/2;
    sm_lifeLevels[10] = 153/2;
    show(); 
}
