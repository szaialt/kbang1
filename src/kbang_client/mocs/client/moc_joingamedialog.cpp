...
void client::JoinGameDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (JoinGameDialog::*_t)(int , int , const QString & , const CreatePlayerData & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&JoinGameDialog::joinGame)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject client::JoinGameDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_client__JoinGameDialog.data,
      qt_meta_data_client__JoinGameDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
