...
void client::Game::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Game::emitLogMessage)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject client::Game::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_client__Game.data,
      qt_meta_data_client__Game,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
