...
QT_INIT_METAOBJECT const QMetaObject client::LocalPlayerWidget::staticMetaObject = {
    { &PlayerWidget::staticMetaObject, qt_meta_stringdata_client__LocalPlayerWidget.data,
      qt_meta_data_client__LocalPlayerWidget,  qt_static_metacall, nullptr, nullptr}
};
...
void *client::LocalPlayerWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::LocalPlayerWidget"))
        return static_cast< Ui::LocalPlayerWidget*>(this);
