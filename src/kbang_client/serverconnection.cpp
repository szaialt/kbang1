...
// void ServerConnection::chooseingCharacter(PublicPlayerData& data){
//     if (mp_parser == 0)
//         return;
//     emit logMessage(tr("Choosing characters."));
//     //emit sigCharacterChoosing(data);
//     mp_parser->eventChoicingCharacter(data);
// 
// }
//
// void ServerConnection::orderingCharacters(PublicPlayerData& data){
//     if (mp_parser == 0)
//         return;
//     emit logMessage(tr("Ordering characters."));
//     //emit sigCharacterOrdering(data);
//     mp_parser->eventOrderingCharacter(data);
// } 

// //Must call functions of mp_parser
// void ServerConnection::choosenCharacter(PublicPlayerData& data){
//     if (mp_parser == 0)
//         return;
//     emit logMessage(tr("Choosen characters."));
//         mp_parser->actionChoicingCharacter(data);
// 
// }
// 
// //Must call functions of mp_parser
// void ServerConnection::orderedCharacters(PublicPlayerData& data){
//     if (mp_parser == 0)
//         return;
//     emit logMessage(tr("Ordered characters."));
//     mp_parser->actionOrderingCharacter(data);
// } 
...
void ServerConnection::playCardWithCardAndPlayer(int cardId, int otherCardId, int playerId){
    if (mp_parser == 0)
        return;
    ActionPlayCardData actionPlayCardData;
    actionPlayCardData.playedCardId = cardId;
    actionPlayCardData.targetCardId = otherCardId;
    actionPlayCardData.targetPlayerId = playerId;
    actionPlayCardData.type = ActionPlayCardData::PLAYCARD_CARD_AND_PLAYER;
    mp_parser->actionPlayCard(actionPlayCardData);
    
}

void ServerConnection::playCardWithCards(int cardId, QList<int> cardIds)
{
    if (mp_parser == 0)
        return;
    ActionPlayCardData actionPlayCardData;
...
void ServerConnection::playCardWithPlayers(int cardId, QList<int> playerIds){
    if (mp_parser == 0)
        return;
    ActionPlayCardData actionPlayCardData;
    actionPlayCardData.playedCardId = cardId;
...
void ServerConnection::useAbility(QList<int> cards, int playerId){
    if (mp_parser == 0)
        return;
    ActionUseAbilityData actionUseAbilityData;
