...
{
    qDebug() << "GameEventHandler::pause()";
    mp_queue->pause();
}

void GameEventHandler::resume()
{
    qDebug() << "GameEventHandler::resume()";
    mp_queue->resume();
}

void GameEventHandler::clear()
{
    qDebug() << "GameEventHandler::clear()";
    mp_queue->clear();
}
...
{
    qDebug() << "GameEventHandler::GameEventHandler::onCardMovementEvent(const CardMovementData& cardMovementData)";
...
{
    qDebug() << "GameEventHandler::onGameContextChangeEvent(const GameContextData& gameContextData)";
...
{
    qDebug() << "GameEventHandler::onGameSyncEvent(const GameSyncData& gameSyncData)";
...
{
    qDebug() << "GameEventHandler::onLifePointsChangeEvent(int playerId, int lifePoints)";
...
{
    qDebug() << "GameEventHandler::onPlayerDiedEvent(int playerId, PlayerRole role)";
...
{
    qDebug() << "GameEventHandler::onPlayerJoinedEvent(const PublicPlayerData& player)";
    mp_queue->add((new PlayerEvent(mp_game))->playerJoined(player));
}

void GameEventHandler::onPlayerLeavedEvent(int playerId)
{
    qDebug() << "GameEventHandler::onPlayerLeavedEvent(int playerId)";
...
{
    qDebug() << "GameEventHandler::onPlayerUpdateEvent(const PublicPlayerData& player)";
...
{
    qDebug() << "onGameMessageEvent(const GameMessage& gameMessage)";
