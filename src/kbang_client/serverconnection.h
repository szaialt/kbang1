...
//     void chooseingCharacter(PublicPlayerData& data);
//     void orderingCharacters(PublicPlayerData& data);
//     void choosenCharacter(PublicPlayerData& data);
//     void orderedCharacters(PublicPlayerData& data);
    ...
    void playCardWithCardAndPlayer(int cardId, int otherCardId, int playerId); 
    void playCardWithCards(int cardId, QList<int> cardIds);
    void playCardWithPlayers(int cardId, QList<int> playerIds); 
    void useAbility();
    void useAbility(int playerId);
    void useAbility(QList<int> cards);
    void useAbility(QList<int> cards, int playerId);
...
// signals:
//     void sigCharacterChoosing(PublicPlayerData& );
//     void sigCharacterOrdering(PublicPlayerData& );
